...
$front_photo = $_FILES['uploaded_documents'];
$back_photo = $_FILES['uploaded_documents1'];
...
$ismatch="";
if($name_match =="Match" && $birth_date_match=="Match")
{
  $ismatch="ok=all";
  $atvy_status="1";
}
