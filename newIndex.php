...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if ($res_agency && mysqli_num_rows($res_agency) > 0) {
        ...
        $weblink_details = "SELECT request_no,obj_1,obj_2,obj_3,upload_weblink,obj_1_verifications,obj_2_verifications,obj_3_verifications FROM `bulk_weblink_request_all` WHERE `agency_id`='$agency_id' AND `bulk_id` = '$bulk_id' AND (`status` = '1' OR `status` = '2')";
            ...
            <div class="wizard-form">
                ...
                <div class="wizard-body" style="display:none" id="wizard-bodyDiv">
                    <div class="containers">
                        <span for="verification-for"><b>Weblink For: </b><span id="verification-for"><?php echo $filename; ?></span></span><br>
                    </div>
                    ...
                    if (response.error) {
                        ...
                        verifications.forEach(function(element, index) {
                            ...
                            if (index === 0) {
                                ...
                                totalRecords = obj_2 || 0;
                            } else if (index === 2) {
                                totalRecords = obj_3 || 0; // Third iteration
                            }
