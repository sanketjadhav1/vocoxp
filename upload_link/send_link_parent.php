<?php 
    $description = "Click the below link pay job token amount";
       ...
       $data = json_encode([
            ...
            // ],
            'reminder_enable' => true,
            'callback_url' => 'https://mounarchtech.com/vocoxp/upload_link/verify_pay_parent.php?end_user_id='.$end_user_id.'&paid_amount='.$amount.'&bulk_id='.$bulk_id.'&gst_number='.$gst_number.'&agency_id='.$agency_id.'&user_ids='.$user_ids.'&obj_no='.$obj_no, 
            'callback_method' => 'get', 
            'notes' => [
