...
if ($check_error == 1) {
    ...
    // link to move on index page 
    $upload_weblink = "https://mounarchtech.com/vocoxp/upload_link/newIndex.php?agency_id=" . $agency_id . "&bulk_id=" . $bulk_id;
        ...
        $mail->Body = '<!DOCTYPE html>
                       ...
                       <body>
                           <div class="email-body">
                               ...
                               <p>'.$type.'</p>
                                   <p>Dear Recipient,</p>                                   
                                   <p><a href="https://mounarchtech.com/vocoxp/upload_link/newIndex.php?agency_id='.$agency_id.'&bulk_id='.$bulk_id.'">Click here to upload the data</a></p>
...
function check_error($agency_id, $excel_no, $email_id) {
    if (empty($agency_id)) {
