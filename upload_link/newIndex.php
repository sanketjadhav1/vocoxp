                        ...
                        `;
                            ...
                            function updateTotalRow() {
                                ...
                                allTotalRow.innerHTML = `
                                    ...
                                    <td class="bg-primary text-light">${totalAmount.toFixed(2)}</td> <!-- colspan to merge cells -->
                                `;
                                ...
                                if (current_wallet_bal < totalAmount) {
                                    ...
                                    $.ajax({
                                        url: 'https://mounarchtech.com/vocoxp/upload_link/update_agency_tentity_amount.php',
                                        type: 'POST',
                                        data: {
                                            agency_id: agencyId,
                                            tentative_amount: totalAmount
                                        },
                                        success: function(response) {
