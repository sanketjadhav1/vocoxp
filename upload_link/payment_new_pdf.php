...
function savePDF($output_pdf, $remote_base_dir, $agency_id, $for, $system_date) {
    $ftp_server = '199.79.62.21';
    $ftp_username = 'centralwp@mounarchtech.com';
    $ftp_password = 'k=Y#oBK{h}OU';

    $new_directory_path = "$agency_id/$for/";
    ...
    $base_url = "https://mounarchtech.com/central_wp/verification_data/voco_xp/$agency_id/$for";
...
$oldPdfUrl = 'https://mounarchtech.com/central_wp/verification_data/voco_xp/' . $agency_id . '/' . $for . '/' . $system_date . '.pdf';
...
$response = savePDF($output_pdf, $remote_base_dir, $agency_id, $for, $system_date);
 
     
    $data = ["error_code" => 100, "message" => "PDF generated successfully.","path"=> $_POST["path"]];
