...
<head>
    ...
    <style>
        ...
        /* Container styling */
        .thank-you-container {
            background-color: rgba(255, 255, 255, 0.5); /* Updated to make it transparent */
            border-radius: 15px;
            padding: 40px;
            text-align: center;
        ...
        .icon-2 {
            top: 30px; /* Adjusted to be slightly lower */
            left: -30px; /* Adjusted to be slightly lower */
            animation-delay: 2s;
        }
        ...
        .icon-4 {
            bottom: 20px; /* Adjusted to position above the bottom */
            right: -70px; /* Adjusted to position above the bottom */
            animation-delay: 3s;
        }
        ...
        /* Success icon */
        .thank-you-container .verification-icon {
            font-size: 60px;
            color:#834caf;
            margin-bottom: 30px;
        }
...
<body style="background-image: url('images/wizard-v4.jpg');">
    ...
    <div class="thank-you-container">
        ...
        <h1>Thank You!!</h1>
        <p>Thank you! You have completed your settings. Now you can see further details in your app!</p>
