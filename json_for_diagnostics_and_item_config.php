...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if($check_error==1){
        ...
        $fetch_product_item="SELECT `display_diagnostic_tool`, `is_item_configuration`, `item_no` FROM product_item_header_all WHERE `item_no`='$item_no'";
        ...
        if(mysqli_num_rows($res_product_item)>0){
            ...
            $data[]=["display_diagnostic_tool"=>$arr_product_item['display_diagnostic_tool']==1?"Yes":"No", "is_item_configuration"=>$arr_product_item['is_item_configuration']==1?"Yes":"No", "item_no"=>$arr_product_item['item_no']];
