...
$edited_dob = DateTime::createFromFormat('d/m/Y', $_POST['edited_dob']);
...
$edited_expiry_date = DateTime::createFromFormat('d/m/Y', $_POST['edited_expiry_date']);
$address = $_POST['address'];
$edited_address = $_POST['edited_address'];
$father_name = $_POST['father_name'];
$edited_father_name = $_POST['edited_father_name'];

$landing_date = DateTime::createFromFormat('d/m/Y', $_POST['landing_date']);
$edited_landing_date = DateTime::createFromFormat('d/m/Y', $_POST['edited_landing_date']);

$visa_validity = DateTime::createFromFormat('d/m/Y', $_POST['visa_validity']);
$edited_visa_validity = DateTime::createFromFormat('d/m/Y', $_POST['edited_visa_validity']);
$country = $_POST['country'];
$edited_country = $_POST['edited_country'];
$visa_type = $_POST['visa_type'];
$edited_visa_type = $_POST['edited_visa_type'];

if ($date_of_birth && $edited_dob && $expiry_date && $edited_expiry_date && $landing_date && $edited_landing_date && $visa_validity && $edited_visa_validity) {
    $date_of_birth = $date_of_birth->format('d-m-Y');
    $edited_dob = $edited_dob->format('d-m-Y');
    $expiry_date = $expiry_date->format('d-m-Y');
    $edited_expiry_date = $edited_expiry_date->format('d-m-Y');
    $landing_date = $landing_date->format('d-m-Y');
    $edited_landing_date = $edited_landing_date->format('d-m-Y');
    $visa_validity = $visa_validity->format('d-m-Y');
    $edited_visa_validity = $edited_visa_validity->format('d-m-Y');
} 
...
// }
//         if ($is_verified == "yes") {
//             $response = verify_passport_number($passport_no, $surname, $given_name, $date_of_birth, $file_number);
// $response_data = json_decode($response, true); // Decode JSON response to associative array
...
//           } 
        ...
        if($visa_photo!=""){
            $visa_photo=save_doc_photo($visa_photo, $direct_id, $agency_id);
        }
    
    // save pan img
   
    // Define the URL
    $url = get_base_url() . '/international_pdf_direct.php';
    ...
    $postdata = array(
        ...
        'edited_landing_date' => $edited_landing_date,
        'visa_validity' => $visa_validity,
        'edited_visa_validity' => $edited_visa_validity,
        'country' => $country,
        'edited_country' => $edited_country,
        'visa_type' => $visa_type,
        'edited_visa_type' => $edited_visa_type,
