                    ...
                    <div class="card p-3 mt-2 allcard">
                        ...
                        <div class="profile-container text-center">
                            <?php if (isset($arr_mem['profile_image']) && !empty($arr_mem['profile_image'])) : ?>
                                <img id="profile_image" src="<?php echo htmlspecialchars($arr_mem['profile_image']); ?>" class="profileimg" alt="Profile Image">
                            <?php else : ?>
                                <img id="profile_image" src="https://mounarchtech.com/vocoxp/empty_rpofile.webp" class="profileimg" alt="Default Profile Image">
                            <?php endif; ?>
                            <label for="profile_img" class="camera-icon">
                                <img src="https://mounarchtech.com/vocoxp/camera.jpg" class="cameraimg" alt="Camera Icon">
                            </label>
