...
// Assuming these values are defined elsewhere in your code
    ...
    $sql_01 = "select * from admin_header_all where agency_id='$agency_id' order by created_on ";
    ...
    if ($mysqli->affected_rows > 0) {
        while ($row_01 = mysqli_fetch_assoc($result_01)) {
         ...
         $responce = ["error_code" => 100, "message" => "admins data fetched","data" => $data];
        echo json_encode($responce);
        return;
    }else{
          $response = ["error_code" => 101, "message" => "No admins data found."];
            echo json_encode($response);
            exit;
    }
